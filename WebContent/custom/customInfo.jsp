...
<div class="content container" id="content">
	...
	<form name="frm1" id="frm1" action="<%=request.getContextPath() %>/UpdateCustomCtrl" method="post" onsubmit="return updateCheck(this)">
		<table class="table">
			<tbody>
				<tr>
					<th>아이디</th>
					<td>
						<input type="text" name="cusId" id="cusId" placeholder="아이디 입력" class="form-control" value="<%=custom.getCusId() %>" autofocus required />						
					</td>
				</tr>
				<tr>
					<th>비밀번호</th>
				...
				<tr>
					<th>비밀번호 확인</th>
					<td>					
						<input type="password" name="edit_cusPw2" id="edit_cusPw2" placeholder="비밀번호 입력" class="form-control" />
					</td>
				</tr>
				<tr>
					<th>고객이름</th>
					<td>					
						<input type="text" name="cusName" id="cusName" placeholder="이름 입력" class="form-control" value="<%=custom.getCusName()%>" required />
					</td>
				</tr>
				<tr>
					<th>주소</th>
					<td>
						...
						<input type="hidden" name="adress" id="address">
						<p>주소 변경시에만 입력하시기 바랍니다.</p>
						<input type="text" name="editaddress1" id="editaddress1" placeholder="기본 주소 입력" class="form-control" />
						<input type="text" name="editaddress2" id="editaddress2" placeholder="상세 주소 입력" class="form-control" />
						...
						<button type="button" id="post_btn" onclick="findAddr()" class="btn btn-primary">우편번호</button>
					</td>
				</tr>
				<tr>
					<th>전화번호</th>
		...
		<div class="btn-group">
			<input type="submit" name="submit-btn" class="btn btn-info" value="정보 수정">
